...
/**
 * this is a Configuration class for the GUI interface
 */
public class Configurations {
    ...
    /**
     * this functions sets the searching algorithm of the board game
     * to the @param solver
     * @param solver the String representation on the desired Algorithm to be set as the searching Algorithm
     */
    ...
    /**
     *  this function returns the searching algorithm the board game instance is currently using
     * @return ISearchingAlgorithm, instance of the Algorithm currently used
     */
    ...
    /**
     * @return the maximum number of Threads available in the system Thread Pool
     * can be found in the config.properties file
     */
